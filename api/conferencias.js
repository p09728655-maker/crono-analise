  ...
  if (req.method === 'GET') {
    ...
    return auth.rls(async (db) => {
      ...
      const linhas = await db`
        SELECT c.id, c.maquina, c.peca, c.iniciado_em, c.finalizado_em, c.duracao_ms, c.pecas, c.ciclos_por_peca, c.furacao_passante, c.observacao, c.salvo_em, c.arquivada,
               coalesce((
