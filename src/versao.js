...
export const HISTORICO = [
  ...
  },
  {
    ...
    itens: [
      'O RELATÓRIO SÓ IMPRIMIA UMA MÁQUINA OU A FÁBRICA INTEIRA. Com furadeira e CNC medidas no mesmo período, "Imprimir todas" junta postos que não se comparam: o topo mostra 674 pç/h de média enquanto as furadeiras estão a 750 e 818 e a CNC a 181 — número que não é o ritmo de nenhuma delas. E imprimir posto a posto obriga a juntar folhas na mão. Faltava a unidade com que se decide capacidade: o grupo.',
      ...
      'O ITEM SOMA AS MEDIÇÕES DAS MÁQUINAS DO GRUPO, como qualquer outro da lateral, e se marca como escolhido. Com um grupo só medido no período ele não aparece: ali "Todas" já é o grupo, e um filtro que não filtra nada só ensina a desconfiar do filtro.',
      'MÁQUINA SEM GRUPO NO CADASTRO continua aparecendo e agora também dá para isolar — mas ela não é chamada de grupo em lugar nenhum: o botão vira "Imprimir as sem grupo" e a folha sai com "Sem grupo no cadastro" no título. É pendência de cadastro, não unidade de capacidade.',
