...
const lista = [
  { id: 'a1', maquina: 'Furadeira 03', peca: '', iniciado_em: dia(30, 7), finalizado_em: dia(30, 7, 30),
    duracao_ms: 1800000, pecas: 350, salvo_em: dia(30, 7, 30), arquivada: false, paradas: [] },
  { id: 'a2', maquina: 'Furadeira 03', peca: '', iniciado_em: dia(31, 7), finalizado_em: dia(31, 7, 30),
    duracao_ms: 1800000, pecas: 350, salvo_em: dia(31, 7, 30), arquivada: false, paradas: [] },
  { id: 'a3', maquina: 'Furadeira 03', peca: '', iniciado_em: dia(31, 13), finalizado_em: dia(31, 13, 30),
